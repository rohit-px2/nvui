...
command! -nargs=1 NvuiExtPopupmenu call rpcnotify(1, 'NVUI_OPTION_SET', "ext_popupmenu", <args>)
command! -nargs=1 NvuiExtCmdline call rpcnotify(1, 'NVUI_OPTION_SET', "ext_cmdline", <args>)
